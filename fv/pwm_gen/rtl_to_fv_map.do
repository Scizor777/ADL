...
# Generated on: Thu Apr 09 13:49:31 IST 2026 (Thu Apr 09 08:19:31 UTC 2026)
...
set logfile fv/pwm_gen/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/pwm_gen -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/install/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/install/GENUS211/tools.lnx86"
set env(CW_DIR) "/install/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/install/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /install/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/install/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/install/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/install/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/install/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
add_search_path . /install/GENUS211/tools.lnx86/lib/tech -library -both
read_library -liberty -both \
    /install/FOUNDRY/digital/180nm/dig/lib/slow.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  pwm.v
elaborate_design -golden -root {pwm_gen} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/pwm_gen/fv_map.v.gz
elaborate_design -revised -root {pwm_gen}
...
#add_name_alias fv/pwm_gen/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.pwm_gen.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.pwm_gen.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.pwm_gen.rtl.fv_map.rpt
